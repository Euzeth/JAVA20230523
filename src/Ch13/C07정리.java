...
class ScientificCalculator	extends Calculator//공학계산기
{
...
public class C07정리 {
	...
	public static void main(String[] args) {
		...
		//오버라이딩(재정의)
		//상속관계를 전제로 하여 상위클래스의 메서드를 하위클래스가 받아 고쳐 사용하는 것을 허용한 문법
		//메서드의 헤더 고정 / 바디 변경
		...
		//-NoCasting
		// 해당클래스 자료형 ref= new 해당클래스생성자()
		
		//-UpCasting
		// 상위클래스자료형으로 ref = (상위클래스자료형)new 하위클래스생성자()
		// 자동형변환
		...
		// upcasting을 전제로 했을 때 확장된 멤버에 접근이 불가능 하기 때문에 해당 자료형으로 형을 강제로 일치 시켜서 확장된 멤버에 접근가능
		// 강제형변환
		
		//-InstanceOf
		// 클래스 자료형을 선별하기 위해서 사용되는 예약어
