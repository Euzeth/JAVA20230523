...
//											// 왼쪽 byte형으로 저장시 작은공간에 큰자료형타입 넣으려
//		int result1 = x + y;
...
//		int var2 = 100;
//		long var3 = 1000L;
//		int result = (int)(var1 + var2 + var3);				// 오른쪽 변수들은 long으로 자동형변환
//															// but 왼쪽 공간이 작은 공간이기 때문에
...
//		System.out.println(result2);
		...
		float flvar = 3.3F;
		double dbvar = 5.5;
		double result3 = intvar + flvar + dbvar;	// intvar, flvar 가 각각 double형으로 형변환
